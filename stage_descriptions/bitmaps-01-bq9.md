...
- As bitmaps are strings, we suggest that you store them using the same data structure you already use for `SET` and `GET`. It'll come in handy in later stages.
