...
- In this stage, you'll only need to handle growing an existing key by a small offset. You won't need to handle out-of-range offsets, or `SETBIT` on a bit that is already `1`.
